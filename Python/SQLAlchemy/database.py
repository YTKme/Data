...
CURRENT_MODULE_PATH = Path(__file__).parent[1].expanduser().resolve()
...
def get_database_session_async() -> async_sessionmaker[AsyncSession]:
    ...
    username = os.environ.get("BOREALIS_USERNAME")
    password = os.environ.get("BOREALIS_PASSWORD")
    host = os.environ.get("BOREALIS_HOST", "sparkle.corp.adobe.com")
